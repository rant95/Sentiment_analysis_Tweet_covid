...
val hashingTF = new HashingTF()
  .setInputCol("tokens").setOutputCol("rawFeatures").setNumFeatures(15000)
...
val cvPredictionDf = randomForestModel.transform(testData)
...
// test model with test data
val cvPredictionTestDf = randomForestModel.transform(labeltestDf)
//cvPredictionTestDf.show(10)
...
//println(CVmodel.asInstanceOf[RandomForestClassificationModel].toDebugString)
